    ...
    val definitions: List<McpToolDefinition> = listOf(
        ...
        McpToolDefinition(
            ...
            objectSchema(
                ...
                "delay_ms" to integer("Fixed delay before returning the mock response", minimum = 0, maximum = Int.MAX_VALUE),
                "headers" to headers(),
        ...
        McpToolDefinition(
            ...
            objectSchema(
                ...
                "delay_ms" to integer("Fixed delay before returning the seeded response", minimum = 0, maximum = Int.MAX_VALUE),
                "headers" to headers(),
                "body_text" to string("UTF-8 response body"),
                "body_base64" to string("Base64 response body; mutually exclusive with body_text"),
