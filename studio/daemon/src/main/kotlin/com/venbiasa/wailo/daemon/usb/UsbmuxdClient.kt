...
/**
 * Minimal plist-v1 client for Apple's built-in usbmuxd. A successful Connect socket becomes the raw
 * byte stream to Wailo's listener on the attached iOS device.
 */
...
private fun Element?.intValue(default: Int = 0): Int =
    this?.textContent?.toLongOrNull()?.toInt() ?: default
